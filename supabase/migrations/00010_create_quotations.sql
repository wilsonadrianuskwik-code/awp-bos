...
CREATE INDEX idx_quotations_workspace ON quotations(workspace_id) WHERE deleted_at IS NULL;
CREATE INDEX idx_quotations_client ON quotations(client_id) WHERE deleted_at IS NULL;
CREATE INDEX idx_quotations_status ON quotations(workspace_id, status) WHERE deleted_at IS NULL;
CREATE INDEX idx_quotations_parent ON quotations(parent_quotation_id) WHERE deleted_at IS NULL;
