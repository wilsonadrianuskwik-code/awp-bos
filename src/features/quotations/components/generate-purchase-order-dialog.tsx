...
/**
 * A Purchase Order is issued to a supplier, but a Quotation is a
 * customer-facing document that names no supplier — so the generic
 * quotation -> purchase_order field mapping can't populate supplier_id
 * (create_purchase_order rejects the call without one). This collects
 * that single missing field and passes it through generate_document's
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Creates a draft purchase order from {quotationNumber}, copying its
