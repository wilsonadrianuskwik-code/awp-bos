...
export function QuotationBuilder({
  ...
  const inFlightRef = useRef<Promise<Quotation | null> | null>(null);
  ...
  const saveDraftInner = useCallback(async (): Promise<Quotation | null> => {
  ...
  return (
    <div className="mx-auto w-full max-w-[880px] space-y-4">
      ...
      <DocumentPreviewDialog
        ...
        meta={[
          { label: "Quotation Date", value: issueDate || "—" },
